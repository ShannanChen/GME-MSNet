...
from networks.UNet.MSNet import UNet
...
if args.network == '3DUXNET':
    ...
    model = nnFormer(input_channels=3, num_classes=out_classes).to(device)
...
def validation(epoch_iterator_val):
    ...
    with torch.no_grad():
        for step, batch in enumerate(epoch_iterator_val):
            ...
            val_outputs = sliding_window_inference(val_inputs, (64, 64, 64), 2, model)
