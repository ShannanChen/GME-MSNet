...
from networks.GME_MSNet.GME_MSNet import GME_MSNet
...
elif args.network == 'GME_MSNet':
    model = GME_MSNet(n_channels=3, n_classes=out_classes, width_multiplier=1, trilinear=True, use_ds_conv=False).to(device)
...
def train(global_step, train_loader, dice_val_best, hd_val_best, global_step_best):
    ...
    for step, batch in enumerate(epoch_iterator):
        ...
        logit_map_fusion, logit_map_adc, logit_map_flair, logit_map_dwi = model(x)
